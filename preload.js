...
{    
    ...
    game.load.spritesheet('lHand',                    'Assets/myndir/Hands/lhand.png',249,400);
    game.load.spritesheet('rHand',                    'Assets/myndir/Hands/hhand.png',343,400);
    ...
    game.load.audio('endirFJ',          'Assets/hljod/audio/Marglytta_07.mp3');
    ...
    game.load.audio('byrjunDK',         'Assets/hljod/audio/Fusi_Froskur_02.mp3');
    game.load.audio('findTDK',          'Assets/hljod/audio/Fusi_Froskur_03.mp3');
